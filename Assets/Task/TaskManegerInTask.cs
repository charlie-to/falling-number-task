...
public class TaskManegerInTask : TaskManager
{
    ...
    private void Start()
    {
        taskData = new TaskData(TaskManager.SubjectNum, TaskManager.FallingSpeed, TaskManager.NumberSpawnDelayTime, TaskManager.Life, TaskManager.NumberOfDeleteOnDecLife, TaskManager.RangeOfDeleteOnDecreaseLife);
    }
